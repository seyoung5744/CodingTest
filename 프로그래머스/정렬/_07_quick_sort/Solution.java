package 프로그래머스.정렬._07_quick_sort;
...
class QuickSort {
    ...
    public static void l_pivot_sort(int[] a, int lo, int hi) {
         ...
         *
         */
        int pivot = l_pivot_sort_partition(a, lo, hi);
     ...
     */
    private static int l_pivot_sort_partition(int[] a, int left, int right) {
        int lo = left;
        int hi = right;
    ...
    public static void r_pivot_sort(int[] a, int lo, int hi) {
         ...
         *
         */
        int pivot = r_pivot_sort_partition(a, lo, hi);
     ...
     * @return 최종적으로 위치한 피벗의 위치(lo)를 반환
     */
    private static int r_pivot_sort_partition(int[] a, int left, int right) {
        int lo = left;
        int hi = right;
    ...
    public static void m_pivot_sort(int[] a, int lo, int hi) {
         ...
         *
         */
        int pivot = m_pivot_sort_partition(a, lo, hi);
     ...
     */
    private static int m_pivot_sort_partition(int[] a, int left, int right) {
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        l_pivot_test(Arrays.copyOf(arr, arr.length));
        r_pivot_test(Arrays.copyOf(arr, arr.length));
        m_pivot_test(Arrays.copyOf(arr, arr.length));
    }

    private static void l_pivot_test(int[] arr) {
        System.out.println(Arrays.toString(arr));
        QuickSort.l_pivot_sort(arr, 0, arr.length - 1);
        System.out.println(Arrays.toString(arr));
        System.out.println("====================");
    }

    private static void r_pivot_test(int[] arr) {
        System.out.println(Arrays.toString(arr));
        QuickSort.r_pivot_sort(arr, 0, arr.length - 1);
        System.out.println(Arrays.toString(arr));
        System.out.println("====================");
    }

    private static void m_pivot_test(int[] arr) {
        System.out.println(Arrays.toString(arr));
        QuickSort.m_pivot_sort(arr, 0, arr.length - 1);
        System.out.println(Arrays.toString(arr));
        System.out.println("====================");
    }
}
